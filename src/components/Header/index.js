...
const Header = () => {
  ...
  return (
    <nav className="bg-purple-image">
      <div className="flex sm:flex-wrap md:flex-wrap items-center justify-between max-w-3xl mx-auto sm:px-0 px-4 pb-8 sm:pb-0 md:max-w-2xl md:pt-8 md:mt-8">
        <div className="w-1/2 sm:w-full text-white mb-8 pb-8 sm:pb-0 sm:mb-0 sm:px-8 md:mx-auto md:w-3/4">
          <img src={Davos_logo} className="w-64 h-32 -mt-8 sm:w-32 md:w-32" />
          <h1 className="capitalize mb-4 sm:text-2xl sm:text-center md:leading-normal">
        ...
        <div className='w-4/5 sm:w-full sm:pb-0 md:-mt-8 md:mx-auto'>
          <img src={header_illustration} className="relative pin-r pin-b mb-8 pb-8 sm:mb-0 sm:pb-0 md:-mt-8" />
        </div>
      </div>
    </nav>
  );
