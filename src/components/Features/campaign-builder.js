...
const CampaignBuilder = () => (
  <div className="flex" style={{ marginTop: "300px"}}>
    <div className="w-1/3 mt-8 shadow-lg rounded-lg" style={{height: "80%"}}>
      ...
      <div className="text-white bg-teal px-10 mx-auto py-8 rounded-b-lg">
    ...
    <div className="w-2/3">
      ...
      <div className="flex content-between self-start relative mx-16" style={{top: "-100px" }}>
        ...
        <div className="">
          <Link to="/dashboard/"><button className="bg-white flex-none w-2/3 ml-16 text-purple border border-purple text font-bold py-2 px-8 rounded-full capitalize mt-8 mb-4">Next</button></Link>
